...
{
    return [
        'user_id' => $this->reserva->user->id ?? null, // Agregar el ID del usuario
        'mensaje' => $this->reserva->user ? 'Nueva reserva creada por ' . $this->reserva->user->name : 'Usuario no encontrado',
        ...
        'tipo_servicio' => $this->reserva->tipo_servicio,
    ];
}
