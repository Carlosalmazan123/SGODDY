        ...
        <form action="{{ route('inventario.store') }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="number" name="cantidad" id="cantidad" value="{{ old('cantidad') }}" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    @error('cantidad')
                        <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                    @enderror
                </div>
