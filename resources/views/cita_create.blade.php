        ...
        <div class="bg-white shadow-md rounded-lg p-8 max-w-4xl mx-auto">
            ...
            <form action="{{ route('citas.store') }}"  method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="propietario_nombre" name="propietario_nombre" class="w-full p-3 mt-1 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" readonly>
