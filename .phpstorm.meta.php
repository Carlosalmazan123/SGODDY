...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\SGODDY\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\SGODDY\\public\\storage','logging.default',
...
'sanctum.csrf-cookie','welcome','dashboard','profile.edit','profile.update','profile.destroy',
'tickets.inicio','profile.update','historial.create','historial.store',
'historial.edit','historial.update','users.index','users.create','users.store',
'users.show','users.edit','users.update','users.destroy','roles.index',
'roles.create','roles.store','roles.show','roles.edit','roles.update',
'roles.destroy','propietarios.index','propietarios.create','propietarios.store','propietarios.show',
'propietarios.edit','propietarios.update','propietarios.destroy','pacientes.index','pacientes.create',
'pacientes.store','pacientes.show','pacientes.edit','pacientes.update','pacientes.destroy',
'categorias.index','categorias.create','categorias.store','categorias.show','categorias.edit',
'categorias.update','categorias.destroy','proveedores.index','proveedores.create','proveedores.store',
'proveedores.show','proveedores.edit','proveedores.update','proveedores.destroy','productos.index',
'productos.create','productos.store','productos.show','productos.edit','productos.update',
'productos.destroy','citas.index','citas.create','citas.store','citas.show',
'citas.edit','citas.update','citas.destroy','inventario.index','inventario.create',
'inventario.store','inventario.show','inventario.edit','inventario.update','inventario.destroy',
'facturas.index','facturas.create','facturas.store','facturas.show','facturas.edit',
'facturas.update','facturas.destroy','servicios.index','servicios.create','servicios.store',
'servicios.show','servicios.edit','servicios.update','servicios.destroy','tickets.generar',
'tickets.atender','notificaciones.marcarLeida','notificaciones.leerTodas','tickets.index',
'tickets.create','tickets.store','tickets.show','tickets.edit','tickets.update',
'tickets.destroy','login','logout','register','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','users.roles.edit','users.roles.update','roles.permissions.edit','roles.permissions.update',
'storage.local',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.ticketv','auth.verify-email','categoria_create','categoria_edit','categoria_index',
'cita_create','cita_edit','cita_index','cita_show','components.application-logo',
...
'components.secondary-button','components.text-input','dashboard','factura_create','factura_edit',
'factura_index','historial_create','historial_edit','historial_index','historial_show',
'inicio','inventario_create','inventario_edit','inventario_index','layouts.app',
'layouts.guest','layouts.navigation','paciente_create','paciente_edit','paciente_index',
'paciente_show','producto_create','producto_edit','producto_index','producto_show',
'profile.edit','profile.partials.delete-user-form','profile.partials.perfil-image-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
'propietario_create','propietario_edit','propietario_index','propietario_show','proveedor_create',
'proveedor_edit','proveedor_index','role_create','role_edit','role_index',
'role_permission_edit','servicio_create','servicio_edit','servicio_index','ticket_index',
'ticket_inicio','ticket_show','user_create','user_edit','user_index',
'user_role_edit','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
